                            ...
                            <div class="container content-sm">
                                    <div class="row">
                                            <div class="col-md-6 md-margin-bottom-50">
                                                    <img class="img-responsive" src="assets/img/greeplus-bland.png" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                    <br><br><br>
                                                    <div class="headline-left margin-bottom-30">
                                                            <h2 class="headline-brd" align="center">...สร้างความมั่นใจให้กับธุรกิจของคุณ...</h2>
															<h2 class="headline-brd" align="center">สินค้าคุณภาพ ราคาโรงงานผลิต</h2>
															<br>
                                                            <p>ปี 2518 บริษัท ถาวรอีเล็คทริค จำกัด ได้ถูกบุกเบิกขึ้น เป็นโรงงานผู้ผลิตอุปกรณ์ด้านอีเล็คโทรนิคส์สินค้าเครื่องใช้ไฟฟ้า ภายใต้แบรนด์คุณภาพ   ซึ่งเป็นที่รู้จักมาแล้วทั่วประเทศ บริษัทฯ ดำเนินธุรกิจตลอดมาโดยมิได้หยุดยังในการพัฒนาสินค้าใหม่ๆ เพื่อตอบสนองความต้องของผู้บริโภค และเจ้าของธุรกิจ</p>
															<p></p>
                                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3 map-img md-margin-bottom-40">
                                                    ...
                                                    <address class="md-margin-bottom-40">
															73/1 ซอยนวมินทร์ 50  ถนนนวมินทร์<br />
															แขวงคลองกุ่ม เขตบึงกุ่ม กรุงเทพฯ 10240  <br />
															โทรศัพท์ : 0-2733-4507, 0-2733-5468-71 <br />
															โทรสาร : 0-2374-0101 <br />
                                                            Email:sales@tavon.co.th <!--<a href="mailto:info@anybiz.com" class="">info@anybiz.com</a>-->
                                                    </address>
                                            </div><!--/col-md-3-->
                                            <!-- End Address -->
                                    </div>
